...
\begin{enumerate}
 \item \verb|strict| -- domylnie, klasa stara siê jak najcilej wype³niaæ zalecenia
...
Lista pakietów, które s¹ wymagane do kompilacji (wiêkszoæ z nich jest zapewne zainstalowana
domylnie)
\begin{enumerate}
