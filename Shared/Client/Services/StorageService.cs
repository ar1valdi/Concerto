...
{
    public Task<FolderContent> GetFolderContent(long folderId);
    public Task<FolderSettings> GetFolderSettings(long folderId);
...
public class StorageService : IStorageService
{
    ...
    public async Task<FolderContent> GetFolderContent(long folderId) => await _storageClient.GetFolderContentAsync(folderId);
    public async Task<FolderSettings> GetFolderSettings(long folderId) => await _storageClient.GetFolderSettingsAsync(folderId);
